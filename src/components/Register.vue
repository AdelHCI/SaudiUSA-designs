          ...
          <v-card-text>
            <v-form v-model="valid">
              ...
              <v-text-field
                ...
                v-model="cpwd"
              ></v-text-field>
              <v-btn color="primary" v-if="!verify" @click="register" :disabled="!valid">سجل</v-btn>
              <v-text-field
                v-if="verify"
                label="رمز التوثيق"
                :messages="codeMsg"
                ...
                v-model="code"
              ></v-text-field>
              <v-btn color="primary" v-if="verify" @click="verifyCode" :disabled="!valid">وثق الحساب</v-btn>
            </v-form>
          </v-card-text>
        </v-card>
      </v-col>
